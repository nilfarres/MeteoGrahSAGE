...
aprofitant la GPU per a operacions numèriques amb Cupy i paral·lelitzant el processament
per reduir el temps d'execució.

Aquest codi fa exactament el mateix que el codi original, amb les següents millores:
